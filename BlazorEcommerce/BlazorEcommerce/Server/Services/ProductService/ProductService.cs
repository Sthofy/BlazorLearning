namespace BlazorEcommerce.Server.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        public async Task<ServiceResponse<List<Product>>> GetProductsByCaterogry(string categoryUrl)
        {
            var response = new ServiceResponse<List<Product>>
            {
                Data = await _context.Products
        ...
        public async Task<ServiceResponse<ProductSearchResult>> SerachProducts(string searchText, int page)
        {
            var pageResults = 2f;
